...
export const ABIs: any = {
	WitAppliance: require("../../artifacts/contracts/interfaces/IWitAppliance.sol/IWitAppliance.json").abi,
	...
	WitRandomnessV2: require("../../artifacts/contracts/WitRandomnessLegacy.sol/WitRandomnessLegacy.json").abi,
	WitRandomnessV3: require("../../artifacts/contracts/WitRandomness.sol/WitRandomness.json").abi,
