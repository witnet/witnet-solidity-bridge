...
module.exports = {
	...
	zksolc: {
		...
		settings: {
			codegen: "evmla",
			// optional.  Enables Yul instructions available only for ZKsync system contracts and libraries
			...
			libraries: {
				...
				"contracts/libs/WitOracleResultStatusLib.sol": {
					WitOracleResultStatusLib:
						"0x12717Bdcfd40BD7Fa9216E979AE846f076B38F0a",
				},
			...
			missingLibrariesPath:
				"./migrations/zksync/missingLibraryDependencies.json", // optional. This path serves as a cache that stores all the libraries that are missing or have dependencies on other libraries. A `hardhat-zksync-deploy` plugin uses this cache later to compile and deploy the libraries, especially when the `deploy-zksync:libraries` task is executed
			optimizer: {
				enabled: true,
				// optional. 3 by default, z to optimize bytecode size
				mode: "z",
