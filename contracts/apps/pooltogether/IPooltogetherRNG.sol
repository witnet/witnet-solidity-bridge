...
/**
 * @title Random Number Generator Interface as defined by Pooltogether.
 * @notice Provides an interface for requesting random numbers from 3rd-party RNG services.
 */
interface IPooltogetherRNG {
  /**
