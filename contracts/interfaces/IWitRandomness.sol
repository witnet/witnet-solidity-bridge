...
interface IWitRandomness {
    ...
    function fetchRandomnessAfterProof(Witnet.BlockNumber blockNumber) external view returns (
    ...
    function getRandomizeData(Witnet.BlockNumber blockNumber) external view returns (
            Witnet.QueryId queryId,
            Witnet.BlockNumber prevRandomizeBlock, 
            Witnet.BlockNumber nextRandomizeBlock
        );
    ...
    function getRandomizeNextBlock(Witnet.BlockNumber blockNumber) external view returns (Witnet.BlockNumber); 
    ...
    function getRandomizePrevBlock(Witnet.BlockNumber blockNumber) external view returns (Witnet.BlockNumber);
    ...
    function isRandomized(Witnet.BlockNumber blockNumber) external view returns (bool);
    ...
    /// @return Funds actually paid as randomize fee. 
    function randomizeWithParams(RandomizeSLA calldata) external payable returns (uint256);
