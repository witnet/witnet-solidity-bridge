...
interface IWitnetRandomness {
    ...
    event Randomizing(uint256 blockNumber, uint256 witnetQueryId, uint256 witnetEvmReward);
    ...
    /// @return witnetEvmFinalityBlock EVM block number from which the provided randomness can be considered to be final.
    ...
    /// @notice Returns address of the Witnet-compliant data request being used for solving randomness.
