...
interface IWitnetRequestBoard {
    ...
    function getQueryResultAuditTrail(uint256 queryId) external view returns (uint256 _resultTimestamp, bytes32 _resultDrTxHash);
    ...
    /// @param queryId The unique query identifier.
    function getQueryResultStatus(uint256 queryId) external view returns (Witnet.ResultStatus);
