...
/// @title Ancillary deployable library for WitPriceFeeds.
/// @dev Features:
/// @dev - deployment of counter-factual IWitPriceFeedsSolver instances.
/// @dev - validation of feed caption strings.
/// @author The Witnet Foundation.
library WitPriceFeedsLib {
        ...
        returns (address _solver)
    {
        ...
        if (_solver.code.length == 0) {
            ...
            require(
                ...
                "WitPriceFeedsLib: uncompliant solver implementation"
            );
        }
    }
        ...
        returns (uint8)
    {
        require(
            ...
            "WitPriceFeedsLib: bad caption prefix"
        );
        ...
        require(_success, "WitPriceFeedsLib: bad decimals");
