...
contract('WitnetBytecodes', (accounts) => {
    ...
    context("IWitnetBytecodes", async () => {
        ...
        var concathashReducerHash
        var concathashReducerBytecode
        var modeNoFiltersReducerHash
        var modeNoFitlersReducerBytecode
        var stdev15ReducerHash
        var stdev25ReducerHash
        ...
        var btcUsdPriceFeedHash
        var btcUsdPriceFeedBytecode
        var fraxUsdtPriceFeedHash
        var fraxUsdtPriceFeedBytecode
        ...
        context("verifyRadonReducer(..)", async() => {
            ...
            it('verifying radon reducer with stdev filter and args works', async () => {
                var tx = await bytecodes.verifyRadonReducer([
                    3, // AverageMean
                    [
